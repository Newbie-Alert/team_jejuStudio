export const data = [
  {
    id: 1,
    name: '차은우',
    category: ['커플사진', '단체사진', '행사사진', '가족사진'],
    outdoor: true,
    area: '애월',
    comment: '감성이 가득한 작업물을 만들어드립니다.',
    avatar: '/assets/profileImg/차은우.JPG',
  ...
  },
  {
    ...
    avatar: '/assets/profileImg/이영지.JPG',
